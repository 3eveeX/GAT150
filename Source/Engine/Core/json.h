...
#define JSON_READ(value, data) whermst::json::Read(value, #data, data)
#define JSON_READ_NAME(value, name, data ) whermst::json::Read(value, name, data)

#define JSON_HAS(value, data) value.HasMember(#data)
#define JSON_GET(value, data) value[#data]

namespace whermst::json
{
